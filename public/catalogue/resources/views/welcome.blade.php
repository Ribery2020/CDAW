    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Dou Ban for Film</h1>
                    <p class="lead fw-normal text-white-50 mb-0">CDAW projet 2021</p>
                </div>
            </div>
        </header>
        ...
        <div class="container px-4 px-lg-5 mt-5">
                ...
                for ($i=1; $i<=8; $i++){
                    ...
                    echo '<img class="card-img-top" src="' . $result_read['0']->image . '" width="300" height="200">';
                    echo '<div class="card-body p-4">';
                    echo '<div class="text-center">';
                    $result_read = DB::select('select * from table_media where id='.$i);
                    echo '<h5 class="fw-bolder">' . $result_read['0']->title . '</h5>';
                    echo '</div>';
                    echo '</div>';
                    echo '<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">';
                    echo '<div class="text-center"><a class="btn btn-outline-dark mt-auto" href="films/'. $result_read['0']->imdb_id .'">More Details</a></div>';
                    echo '</div>';
                    echo '</div>';
                    echo '</div>';
                }?>                        
